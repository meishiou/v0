...
const sectionCopy = {
  en: {
    ...
    priceNote: "Weekday → Lunar New Year",
...
const rooms: Record<InternationalLocale, Room[]> = {
  ...
  ja: [
    ...
    { key: "mix", image: "/images/international/room-mix.webp", name: "The Mix Room", zhName: "米斯洛克", area: "約38 m²", guests: "定員 4名", bed: "クイーンベッド 1台 + シングルベッド 2台", bathroom: "専用バスルーム · シャワーエリア分離", extra: "エキストラベッド不可", feature: "すべり台＆クライミング遊具", price: "NT$4,000 — 6,800 / 1室", alt: "ベッド、すべり台、クライミング遊具がある米修B&Bの米斯洛克。", amenities: ["ac", "tv", "dehumidifier", "wifi", "slide", "bathroomHeater", "towels", "toiletries", "hairDryer", "sharedFridge", "more"] },
  ],
  ko: [
