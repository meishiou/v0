...
const copy = {
  ...
  ko: { eyebrow: "PRIVATE STAY", title: "필요한 객실만 예약하고,\n공용 공간은 우리끼리.", intro: "가족이나 친구와 함께 여행하시나요? 필요한 객실만 예약하고, 머무는 동안 다른 팀의 예약을 받지 않아 공용 공간을 일행끼리 편안하게 이용할 수 있습니다.", card: "우리 일행만의 속도로 머무는 공간.", body: "필요한 객실만 예약하세요. 사용하지 않는 객실은 닫아 두고, 거실과 공용 공간은 숙박 기간 동안 일행만 이용할 수 있습니다.", larger: "인원이 많은 경우에는 숙소 전체 대관도 문의하실 수 있습니다.", pricing: "필요한 객실만 예약하실 수 있습니다. 나머지 객실을 다른 고객에게 판매하지 않고 일행만 이용할 수 있도록, 사용하지 않는 객실 1실당 평일 NT$1,500 / 주말·공휴일 NT$2,000의 추가 요금이 적용됩니다.", cta: "이메일로 문의하기", note: "숙박 날짜, 인원, 필요한 객실 수를 알려 주세요.", alt: "큰 창으로 이란의 전원 풍경이 보이는 Meishiou B&B의 공용 거실과 다이닝 공간." },
