...
const copy = {
  ...
  ko: {
    eyebrow: "GETTING HERE",
    title: "뤄둥과 가깝고,\n문밖에는 이란의 전원 풍경.",
    intro: "Meishiou B&B는 이란의 한적한 전원 지역에 있으며 뤄둥과 안농강에서 가깝습니다. 주요 대중교통 거점은 뤄둥이며, 주변 여행은 자동차가 가장 편리합니다.",
    locationLabel: "LOCATION",
    locationTitle: "Meishiou B&B",
    ...
    localValue: "1792 또는 1798번 버스 · Kezilin 정류장 하차",
    busInfo: "버스 정보",
    carLabel: "BY CAR",
    carTitle: "전원 지역까지 편리한 차량 이동",
    address: "No. 415, Guanghua 1st Rd., Kelin Village, Dongshan Township, Yilan County, Taiwan",
    interchange: "뤄둥 인터체인지에서 차량으로 약 20분입니다.",
    parking: "숙소 내 무료 주차가 가능합니다.\n전기차 충전 시설도 이용할 수 있습니다.",
    stay: "도착 전에 알아두면 좋은 안내.",
    items: [["체크인", "오후 3시 이후"], ["체크아웃", "오전 11시 이전"], ["아침 식사", "홈메이드 조식 포함*"], ["주차", "숙소 내 무료 주차"], ["야간", "오후 10시 이후에는 조용히"], ["자전거", "투숙객 무료 이용"]],
